...
@JsonPropertyOrder(value = {ScrapedObjectModel.TITLE, ScrapedObjectModel.KCAL,
		ScrapedObjectModel.UNIT_PRICE, ScrapedObjectModel.DESCRIPTION})
public class ScrapedObjectModel
{
